...
namespace Microsoft.EntityFrameworkCore
{
    ...
    public class DbContextOptionsBuilder : IDbContextOptionsBuilderInfrastructure
    {
        ...
        ///     </para>
        ///     <para>
        ///         This overload allows the minimal level of logging and the log formatting to be controlled.
        ...
        ///     Formatting options for log messages. Defaults to <see cref="SimpleLoggerFormatOptions.DefaultWithLocalTime" />
        /// </param>
        /// <returns> The same builder instance so that multiple calls can be chained. </returns>
        public virtual DbContextOptionsBuilder LogTo(
            [NotNull] Action<string> sink,
            LogLevel minimumLevel = LogLevel.Debug,
            SimpleLoggerFormatOptions formatOptions = SimpleLoggerFormatOptions.DefaultWithLocalTime)
            ...
            SimpleLoggerFormatOptions formatOptions = SimpleLoggerFormatOptions.DefaultWithLocalTime)
        {
            ...
            return LogTo(
                sink,
                (i, l) => l >= minimumLevel
                    && categoriesArray.Any(c => i.Name.StartsWith(c, StringComparison.OrdinalIgnoreCase)),
                formatOptions);
        }
            ...
            SimpleLoggerFormatOptions formatOptions = SimpleLoggerFormatOptions.DefaultWithLocalTime)
        {
            ...
            return LogTo(new SimpleLogger(sink, filter, formatOptions));
        }
