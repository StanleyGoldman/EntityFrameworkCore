...
namespace Microsoft.EntityFrameworkCore.Diagnostics
{
    ...
    public enum SimpleLoggerFormatOptions
    {
        ...
        /// <summary>
        ///     Includes the event <see cref="DbLoggerCategory" /> category in each message. The category is included by default.
        /// </summary>
        Category = 1 << 2,

        /// <summary>
        ///     Includes the <see cref="EventId" />i n each message. The event ID is included by default.
        /// </summary>
        Id = 1 << 3,

        /// <summary>
        ///     Includes a UTC timestamp in each message. The local time is included by default. Use <see cref="DefaultWithUtcTime" />
        ///     to include all default options by change timestamps to UTC.
        /// </summary>
        UtcTime = 1 << 4,
